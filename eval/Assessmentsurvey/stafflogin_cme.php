<?php
    ...
    ob_end_flush();
    if(isset($_SESSION['login_id'])) header("location:staff_cme_index.php?page=home");
    ?>
...
<body>
    ...
    <div class="login-container">
        <h1>Insightrix | <span style="color: teal;">LOGIN staff-CME<span></h1>
    ...
    $('#login-form').submit(function(e){
        e.preventDefault();
        $.ajax({
            url:'ajax.php?action=login4_cme',
            method:'POST',
            data:$(this).serialize(),
            error:err=>{
                console.log(err)
            ...
            success:function(resp){
                if(resp == 'CME'){
                    location.href ='staff_cme_index.php?page=home';
                } else if(resp == 2){
