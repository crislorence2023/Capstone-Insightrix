    ...
    $.ajax({
        ...
        success: function(response) {
            try {
                ...
                // If you want to display department stats, you can add them to your HTML
                if (stats.departmentStats) {
                    ...
                    // Assuming you have a container for department stats
        ...
        // Call this function when page loads and after new assignments
        $(document).ready(function() {
            updateDashboardStats();
            // Add to your existing success callbacks where appropriate
        });
});
