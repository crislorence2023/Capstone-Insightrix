...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			function generate_department_table($dept_name, $dept_subjects) {
				$i = 1;
				?>
				<div class="department-container mb-4">
					<h3><?php echo $dept_name != '' ? $dept_name . ' Department' : 'Unassigned Department'; ?></h3>
					
					<table class="table table-hover table-bordered subject-table">
						<colgroup>
							<col width="5%">
							<col width="15%">
							<col width="20%">
						...
						<tbody>
							<?php foreach($dept_subjects as $row): ?>
							<tr>
			...
			foreach($departments as $dept) {
				if (isset($subjects[$dept])) {
					generate_department_table($dept, $subjects[$dept]);
				}
			}
			?>
		</div>
