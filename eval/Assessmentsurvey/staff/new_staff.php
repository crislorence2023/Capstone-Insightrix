    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-light bg-gradient text-white py-3">
            <div class="d-flex align-items-center">
                <h5 class="mb-0 flex-grow-1"><?php echo $is_edit ? 'Edit Staff' : 'Add New Staff'; ?></h5>
                <button type="button" class="btn btn-outline-primary btn-sm" onclick="location.href = 'index.php?page=staff_list'">
                    Back to List
                </button>
            </div>
        </div>
            ...
            <form action="" id="manage_staff" class="needs-validation" novalidate>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 border-end">
                        <h6 class="text-primary mb-4">Basic Information</h6>
                    ...
                    <!-- Right Column -->
                    <div class="col-md-6">
                        <h6 class="text-primary mb-4">Account Settings</h6>
                        <div class="form-group mb-3">
