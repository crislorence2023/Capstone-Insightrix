...
<body>
    ...
    <div class="card">
        <div class="card-header">
            <h2>Student List</h2>
            <a href="./indexsuperadmin.php?page=new_student" class="btn-add-student">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn-action btn-view view_student" data-id="<?php echo $row['id']; ?>">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                            <a href="./index.php?page=edit_student&id=<?php echo $row['id']; ?>" class="btn-action btn-edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button class="btn-action btn-delete delete_student" data-id="<?php echo $row['id']; ?>">
