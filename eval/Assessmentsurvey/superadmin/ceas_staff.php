...
// Fetch existing staff from CEAS staff table
$staff_query = "SELECT * FROM ceas_staff ORDER BY lastname ASC";
    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-light bg-gradient text-white py-3">
            <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="location.href='indexsuperadmin.php?page=new_ceas-staff'">
                    Add New Staff
                </button>
            </div>
        </div>
