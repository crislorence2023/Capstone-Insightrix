...
// Fetch existing staff from CME staff table
$staff_query = "SELECT * FROM cme_staff ORDER BY lastname ASC";
$staff_result = $conn->query($staff_query);
?>

<!-- Custom modal moved to top -->
...
<!-- Update the CSS for better scrolling -->
<style>
...
.custom-modal-content {
    ...
    max-height: calc(100vh - 4rem); /* Reverted back to original size */
    display: flex;
    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-light bg-gradient text-white py-3">
            <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="location.href='indexsuperadmin.php?page=new_cme-staff'">
                    Add New Staff
                </button>
            </div>
        </div>
