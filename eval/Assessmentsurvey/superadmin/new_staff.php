...
$dept_query = "SELECT id, name FROM department_list WHERE name = 'COT' ORDER BY name ASC";
    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-light bg-gradient text-white py-3">
            <div class="d-flex align-items-center">
                <h5 class="mb-0 flex-grow-1  text-bold"><?php echo $is_edit ? 'Edit Staff' : 'Add New Staff - COT'; ?></h5>
                <button type="button" class="btn btn-outline-primary btn-sm" onclick="location.href = 'indexsuperadmin.php?page=staff_list'">
                    Back to List
                </button>
            </div>
        </div>
        <div class="card-body p-4">
            <form action="" id="manage_staff" class="needs-validation" novalidate>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control" required value="<?php echo $email; ?>" placeholder="Enter email address">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password" class="form-control" 
                                    <?php echo !$is_edit ? 'value="staffeval2024" required' : ''; ?> 
                                    placeholder="<?php echo $is_edit ? 'Leave blank to keep current password' : ''; ?>">
                                <button class="btn btn-outline-secondary" type="button" id="togglePassword">
                                    <i data-lucide="eye"></i>
                                </button>
                            </div>
                            <small class="form-text text-muted">
                                <?php echo $is_edit ? 'Leave blank to keep current password' : "Default password: 'staffeval2024'"; ?>
                            </small>
                        </div>
                ...
                <div class="text-end mt-4 pt-3 border-top">
                    <button type="button" class="btn btn-light me-2" onclick="location.href = 'index.php?page=staff_list'">Cancel</button>
            ...
            if (this.checkValidity()) {
                ...
                $.ajax({
                    ...
                    success: function(resp){
                        if(resp == 1){
                            alert_toast('Staff member successfully saved!', "success");
                            setTimeout(function(){
