...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><?php echo $is_edit ? 'Edit Staff' : 'Add New Staff'; ?></h5>
        </div>
        <div class="card-body">
            <form action="" id="manage_staff" class="needs-validation" novalidate>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password" class="form-control" <?php echo !$is_edit ? 'value="staffeval2024" required' : ''; ?> placeholder="<?php echo $is_edit ? 'Leave blank to keep current password' : ''; ?>">
                                <button class="btn btn-outline-secondary" type="button" id="togglePassword">
                                    <i class="bi bi-eye"></i>
                                </button>
                            </div>
                            <small class="form-text text-muted">
                                <?php echo $is_edit ? 'Leave blank to keep current password' : "Default password is 'staffeval2024'. Please change it after first login."; ?>
                            </small>
                        </div>
                        <div class="form-group mb-3">
                            <label for="cpass" class="form-label">Confirm Password</label>
                            <input type="password" name="cpass" id="cpass" class="form-control" <?php echo !$is_edit ? 'value="staffeval2024" required' : ''; ?>>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-preview me-3">
                                    <img src="<?php echo $avatar ? 'assets/uploads/'.$avatar : 'assets/img/no-image-available.png' ?>" 
                ...
                <div class="text-end mt-3">
                    <button type="button" class="btn btn-secondary" onclick="location.href = 'index.php?page=staff_list'">Cancel</button>
