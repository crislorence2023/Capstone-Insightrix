    ...
    <div class="card shadow-sm rounded-lg">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 text-bold">Academic Year Management</h5>
                <button class="btn btn-primary new_academic">
                    <i class="fa fa-plus mr-2"></i>
                    <span class="button-text">Add New Academic Year</span>
                </button>
            </div>
        </div>
        <div class="card-body">
...
@media screen and (max-width: 768px) {
    .new_academic .button-text {
        display: none;
    }
    .new_academic .fa-plus {
...
$(document).ready(function(){
    ...
    $('.delete_academic').click(function(){
        _conf("Are you sure to delete this academic year?", "delete_academic", [$(this).data('id')]);
    });
