...
<div class="wrapper">
    <?php include 'superadmintopbar.php' ?>
    <?php include 'superadmin/sidebar.php' ?>  <!-- Hardcoded to admin sidebar -->
        ...
        <section class="content">
            <div class="container-fluid">
                <?php 
                    ...
                    if(!file_exists('superadmin/'.$page.".php")){  // Hardcoded to admin directory
                        include '404.html';
                    } else {
