...
// Update the department query to only show CME departments
// $dept_query = "SELECT id, name FROM department_list 
//                WHERE name = 'CME' 
//                ORDER BY name ASC";
    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-light bg-gradient text-white py-3">
            <div class="d-flex align-items-center">
                <h5 class="mb-0 flex-grow-1 text-bold text-dark">Add New Faculty</h5>
                <button type="button" class="btn btn-outline-primary btn-sm" onclick="location.href = 'staff_cme_index.php?page=faculty_list'">
                    Back to List
                </button>
            </div>
        </div>
        <div class="card-body p-4">
            <form action="" id="manage_faculty" class="needs-validation" novalidate>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 border-end">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" value="COE" readonly disabled>
                            <input type="hidden" name="department" value="COE">
                        </div>
                    </div>
                ...
                <div class="text-end mt-4 pt-3 border-top">
                    <button type="button" class="btn btn-light me-2" onclick="location.href = 'staff_coe_index.php?page=staff_faculty_list'">Cancel</button>
                ...
                $.ajax({
                    ...
                    success: function(resp){
                        if(resp == 1){
                            ...
                            setTimeout(function(){
                                location.replace('staff_cme_index.php?page=faculty_list')
                            },750)
                        } else if(resp == 2){
