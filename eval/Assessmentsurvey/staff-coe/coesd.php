...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="./" class="brand-link">
        <div class="brand-wrapper">
            ...
            <span class="brand-title"><b>COE</b></span>
        </div>
    </a>
    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Dashboard -->
                <li class="nav-item">
                    <a href="staff_coe_index.php" class="nav-link nav-home">
                ...
                <li class="nav-item">
                    <a href="staff_coe_index.php?page=evaluation-status" class="nav-link nav-evaluation-status">
                ...
                <li class="nav-item">
                    <a href="staff_coe_index.php?page=Room" class="nav-link nav-class_room">
                ...
                <!-- Academic -->
                <li class="nav-item">
                    <a href="staff_coe_index.php?page=subject_list" class="nav-link nav-subject_list">
                ...
                <li class="nav-item">
                    <a href="staff_coe_index.php?page=class_list" class="nav-link nav-class_list">
                        <i class="ri-group-line"></i>
                        <p>Classes</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="staff_coe_index.php?page=new_faculty" class="nav-link nav-new_faculty tree-item">
                                <i class="ri-add-line"></i>
                                <p>Add New</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="staff_coe_index.php?page=faculty_list" class="nav-link nav-faculty_list tree-item">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="staff_coe_index.php?page=new_student" class="nav-link nav-new_student tree-item">
                                <i class="ri-add-line"></i>
                                <p>Add New</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="staff_coe_index.php?page=student_list" class="nav-link nav-student_list tree-item">
                                <i class="ri-list-unordered"></i>
                                <p>List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="staff_coe_index.php?page=AssignClassSubjects" class="nav-link nav-assign_faculty">
