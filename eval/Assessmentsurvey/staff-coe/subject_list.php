        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <?php
                        // Fetch only COE department subjects
                        $subjects = array();
                        $total_subjects = 0;
                        
                        $subject_query = $conn->query("SELECT * FROM subject_list WHERE department='COE' ORDER BY subject ASC");
                        ...
                        <div class="department-container">
                            <div class="department-header">
                                <h6 class="department-title">COE Department Subjects</h6>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.new_subject').click(function(){
                uni_modal("New Subject","staff-coe/manage_subject.php", "mid-large");
            });

            $('.manage_subject').click(function(){
                uni_modal("Manage Subject","staff-coe/manage_subject.php?id="+$(this).attr('data-id'), "mid-large");
            });
