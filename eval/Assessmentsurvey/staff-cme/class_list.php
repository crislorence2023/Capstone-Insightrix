                    ...
                    <div class="card-body">
                        ...
                        <div class="department-container">
                            <div class="department-header">
                                <h6 class="department-title">CME Department Classes</h6>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.new_class').click(function(){
                uni_modal("New Class","staff-cme/manage_class.php", "mid-large");
            });

            $('.manage_class').click(function(){
                uni_modal("Manage Class","staff-cme/manage_class.php?id="+$(this).attr('data-id'), "mid-large");
            });
